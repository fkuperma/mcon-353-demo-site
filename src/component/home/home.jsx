...
<Box sx={{ flexGrow: 1 }}>
    ...
    >
      ...
      <p class="p">Hi, my name is Fraidy Kuperman, I am currently a student at Touro University majoring in Computer Sceince.
        I am in my fourth and last semester, before graduating. This is my very own home page for this class, Practicum in Software Development.
        Besides Computer Sceince, I love to excercise in my free time and enjoy eating nutritious and healthy foods, it helps me feel healthy and fit.
      </p>
...
<h3>All About My Favorite Healthy Foods</h3>
    <div class="food">
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
          The nutrients in apples provide a range of health benefits. Apples are rich in fiber, vitamins, and minerals, all of which benefit health. They also provide an array of antioxidants. These substances help neutralize free radicals. Free radicals are reactive molecules that can build up as a result of natural processes and environmental pressures.
          </Typography>
           </AccordionDetails>
      </Accordion>
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
          Many studies have shown that nuts provide various health benefits — especially in regards to reducing heart disease risk factors. Here are 9 impressive nuts and their health benefits. In general, nuts are good sources of fat, fiber and protein. Most of the fat in nuts is monounsaturated fat, as well as omega-6 and omega-3 polyunsaturated fat.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
          Vitamin C. This is a powerful, water-soluble antioxidant that is present in high amounts in grapefruit.
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        ...
        <AccordionDetails>
          <Typography>
          Asparagus contains high levels of the amino acid asparagine, making it a natural diuretic. In other words, eating more of the spears can help flush excess fluid and salt from your body, which may help prevent urinary tract infections. “When women are not urinating enough, they can get a UTI,” explains Gans.
          </Typography>
        </AccordionDetails>
      </Accordion>
      <Accordion>
...
<div class="excercise">
    ...
    <h3>We are all a work in progress...</h3><br></br>
